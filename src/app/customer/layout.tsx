...
export default async function CustomerLayout({
  ...
  // Check if the user has cook/seller profiles for shop management links
  ...
  const navItems = [
    { href: "/customer", label: "Home", icon: "◉", badge: false },
    { href: "/customer/kitchen", label: "Kitchen", icon: "🍽", badge: false },
    { href: "/customer/market", label: "Market", icon: "🛍", badge: false },
    ...(isLoggedIn
      ? [
          { href: "/customer/basket", label: "Basket", icon: "🧺", badge: true },
        ]
      : []),
  ];
